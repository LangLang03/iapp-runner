...
public class DbCountFunction extends AbstractFunction {
    private DatabaseManager dbManager;
    
    public DbCountFunction(DatabaseManager dbManager) {
    ...
    public Object call(RuntimeContext context, List<Object> arguments) throws FunctionException {
        ...
        try {
            ...
            throw new FunctionException("Count failed: " + e.getMessage(), e);
        }
    }
