...
public class DbAllFunction extends AbstractFunction {
    private DatabaseManager dbManager;
    
    public DbAllFunction(DatabaseManager dbManager) {
    ...
    public Object call(RuntimeContext context, List<Object> arguments) throws FunctionException {
        ...
        try {
            return db.findAll(table, condition);
        } catch (Exception e) {
            throw new FunctionException("Query failed: " + e.getMessage(), e);
        }
    }
