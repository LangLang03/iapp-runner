...
public class JavaFunction implements IFunction {
    @Override
        ...
        try {
            ...
            if (methodName.contains(".")) {
                ...
                if (parts.length == 2) {
                    ...
                    return context.executeMjavaMethod(moduleName, method, args);
                }
            }
            ...
            throw new FunctionException("Java function call failed: " + methodName, e);
        }
    }
